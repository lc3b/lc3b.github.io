 ...
 * @returns {string}
 */
export function compile_c_to_assembly(source) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.compile_c_to_assembly(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string[]}
 */
export function get_available_headers() {
    const ret = wasm.get_available_headers();
 ...
 */
export function get_header_contents(name) {
    const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_header_contents(ptr0, len0);
    let v2;
    if (ret[0] !== 0) {
